namespace VoxeltoUnity {
	...
	public partial class VoxelEditorWindow : MoenenEditorWindow {
		...
		private static readonly string[] EDITOR_TITLE = new string[4] { "Rigging Editor", "Sprite Editor", "Map Generator", "Cha Generator" };
		private static readonly string[] HEADER_TITLE = new string[4] { "Rigging Editor", "Sprite Editor", "Map Generator", "Character Generator" };
		private static readonly string[] HEADER_TITLE_RICH = new string[4] {
		...
		private void DragInFileGUI () {
			if (CurrentEditorMode != EditorMode.Rigging && CurrentEditorMode != EditorMode.Sprite) { return; }
